// ── Landing pages for Harvey Intel ──────────────────────────

const SERVER = {
  name: "HARVEY INTEL",
  slug: "harvey-intel",
  tagline: "Security intelligence for autonomous agents",
  url: "https://agents.rugslayer.com",
  color: "#00ff88",
  colorDim: "#00cc6a",
  npm: "@meltingpixels/harvey-intel",
  github: "https://github.com/meltingpixelsai/harvey-intel",
  tools: [
    ...
    { name: "get_competitor_intel", desc: "Competitor tracking and analysis", price: "$0.02" },
  ],
};
...
export function landingHtml(): string {
  const { name, tagline, color, url, tools } = SERVER;
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8"/>
